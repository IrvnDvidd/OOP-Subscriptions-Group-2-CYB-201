...
public class Freemium extends Subscription {
    ...
    @Override
    protected void create(DataBase database, Scanner read) {
    ...
    @Override
    protected void update(DataBase database, Scanner read) {
    ...
    @Override
    protected void cancel(DataBase database, Scanner scanner) {
    ...
    @Override
    protected void status(DataBase database, Scanner read) {
